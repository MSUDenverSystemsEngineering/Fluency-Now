...
Try {
	...
	[string]$appVendor = 'Western Standard'
	[string]$appName = 'Fluency Now'
	[string]$appVersion = '4.12.23'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\FluencyNow_Student_Lab.exe" -Parameters '/s /v"/qn"'-WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action Uninstall -Path '{4613513F-1999-4F94-87C8-7313B2A80501}'
